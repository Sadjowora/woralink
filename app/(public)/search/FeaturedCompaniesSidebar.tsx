    ...
    <aside className="hidden lg:col-span-4 lg:block">
      <div className="sticky top-6 space-y-6">
        <Link
          ...
          className="block rounded-xl border border-green-200 bg-white p-5 transition-all duration-150 hover:border-green-300 hover:shadow-sm"
        >
          ...
          <div className="mt-3 flex items-start justify-between gap-3">
            <div>
              <p className="text-sm font-semibold text-gray-900">🌟 L&apos;Entreprise du Jour</p>
              <h3 className="mt-1 text-base font-semibold text-gray-900">
                {fallbackCompanyLabel(companyOfTheDay)}
              </h3>
              <p className="mt-1 text-xs text-gray-500">{companyOfTheDay?.city ?? 'Guinée'}</p>
            </div>
            <Flame className="h-5 w-5 shrink-0 text-green-700" aria-hidden="true" />
          </div>
          <p className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-gray-700">
        ...
        <Link
          ...
          className="block rounded-xl border border-gray-200 bg-white p-5 transition-all duration-150 hover:border-gray-300 hover:shadow-sm"
        >
          <span className="inline-flex items-center rounded-full border border-gray-300 bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-600">
            TOP BRAVOS
          </span>
          <div className="mt-3 flex items-start justify-between gap-3">
            <div>
              <p className="text-sm font-semibold text-gray-900">🏆 Le Champion de la Semaine</p>
              <h3 className="mt-1 text-base font-semibold text-gray-900">
            ...
            <Trophy className="h-5 w-5 shrink-0 text-gray-500" aria-hidden="true" />
          </div>
          <p className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-gray-700">
        ...
        <Link
          ...
          className="block rounded-xl border border-gray-200 bg-gray-50 p-5 transition-all duration-150 hover:border-gray-300 hover:shadow-sm"
        >
          <span className="inline-flex items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-xs font-medium text-gray-600">
            LA VALEUR SURE
          </span>
          <div className="mt-3">
            <p className="text-sm font-semibold text-gray-900">🔥 La PME du Mois</p>
            <h3 className="mt-1 text-base font-semibold text-gray-900">

      ...
      <main className="min-w-0 flex-1">
        <div className="mb-4 rounded-xl border border-gray-200 bg-white p-3 sm:mb-5 sm:p-4">
            ...
            <form action="/search" method="get" className="w-full flex-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-gray-200 bg-white pl-11 pr-4 text-sm text-gray-900 transition-all duration-150 placeholder:text-gray-400 focus:border-green-700 focus:outline-none focus:ring-2 focus:ring-green-700/20"
                />
              </div>
            </form>
          ...
          <div className="mt-3 flex items-center justify-between gap-3 text-xs text-gray-500 sm:mt-4 sm:text-sm">
            <p>
              <span className="font-semibold text-gray-900">{resultsCount}</span> résultat
              {resultsCount > 1 ? 's' : ''}
            </p>
            {city || sector || type ? (
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-gray-100 pt-3">
            <span className="text-xs font-medium uppercase tracking-wide text-gray-500">Tri</span>
            {[

            ...
            <div className="mx-auto w-full px-0 py-2 sm:px-4 sm:py-8 lg:w-3/4">
                ...
                {company && !editing ? (
                    ...
                    <div className="rounded-md border border-gray-200 bg-gray-50 p-3 sm:p-4 text-xs sm:text-sm text-gray-600">
                        ...
                        {' '}
                        <Link href="/dashboard/gallery" className="font-semibold text-primary hover:underline">
                            Gérer ma galerie
                        </Link>
                        .
                    </div>
                    ...
                    {galleryError && (
                        <div className="mt-6 rounded-lg border border-red-200 bg-red-50 p-3 text-xs sm:text-sm text-red-700">
                            {galleryError}
                        </div>
                    )}
                </>
